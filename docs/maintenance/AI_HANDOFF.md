...
- `npm run build`: 成功
- `npm test`: 成功。293 tests pass。Web/shared通常testの固定リストを実行。固定リストは自動発見ではなく、通過確認済みtestだけを含める
...
2. 推奨順は、[`SCAN_PROCESS_NEXT_PLAN.md`](SCAN_PROCESS_NEXT_PLAN.md) のTask 2以降、Home / Project巨大ファイル整理、Quiz巨大ファイル整理、P2-D正式docs昇格
