...
export default function CorrectionScanPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-[var(--color-background)] pt-[54px] font-[var(--font-body)]">
      ...
      <div className="flex items-center gap-2.5 px-[14px] pb-1.5 pt-1">
        ...
        <div className="mr-8 flex-1 text-center font-display text-base font-bold text-[var(--solid-ink)]">添削スキャン</div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-[18px]">
        <div className="flex h-[200px] w-full items-center justify-center rounded-[18px] border-2 border-dashed border-[var(--solid-ink)] bg-[rgba(26,26,26,0.04)]">
          <div className="text-center">
            ...
            <div className="mt-3 text-sm font-bold text-[var(--solid-ink)]">手書きの英文を撮影</div>
            <div className="mt-1 text-[11px] text-[var(--color-muted)]">ノートやプリントを AI が読み取ります</div>
          </div>
        </div>
