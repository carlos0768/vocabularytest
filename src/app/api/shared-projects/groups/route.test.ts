...
test('aggregateStudyGroupStrugglingWords sorts from most missed to least missed', () => {
  const rows = [
    {
      ...
      japanese: '走る',
      wrong_count: 2,
      last_wrong_at: '2026-06-20T00:00:00.000Z',
    },
    {
      user_id: 'user-2',
      word_id: 'word-a2',
      ...
      japanese: '走る',
      wrong_count: 3,
      last_wrong_at: '2026-06-21T00:00:00.000Z',
    },
    {
      user_id: 'user-3',
      word_id: 'word-b',
      ...
      japanese: '本',
      wrong_count: 1,
      last_wrong_at: '2026-06-19T00:00:00.000Z',
    },
  ];
  ...
  assert.deepEqual(
    ...
    [
      { english: 'run', wrongCount: 5, learnerCount: 2 },
