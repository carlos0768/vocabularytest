    ...
    <>
      <SolidPage maxWidth="max-w-lg lg:max-w-2xl">
        <SolidHeader
          ...
          description={`${stats.total}語 / 習得 ${stats.mastered}語${collection.description ? `。${collection.description}` : ''}`}
          ...
          actions={
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="solid-link-secondary h-10 px-3"
                aria-label="本棚を編集"
              >
              ...
              <button
                ...
                className="solid-link-secondary h-10 px-3 text-[var(--color-error)]"
                aria-label="本棚を削除"
              >
        ...
        <div className="space-y-5 lg:space-y-6">
          ...
          {allWords.length > 0 && (
            <section className="space-y-3">
              <SolidSectionTitle icon="school" title="その他の学習モード" />
          ...
          <section className="space-y-2.5 lg:space-y-3 pt-2.5 lg:pt-3 border-t border-[var(--color-border-light)]">
            <SolidSectionTitle icon="menu_book" title="単語一覧" count={`${allWords.length}語`} />
            <WordList
              words={allWords}
          ...
          <section className="space-y-3">
            <div className="flex items-center justify-between">
              <SolidSectionTitle icon="folder" title="所属する単語帳" />
              <button
                onClick={openAddModal}
                className="solid-link-secondary min-h-0 px-3 py-1.5 text-xs"
              >
          ...
          {(() => {
            ...
            return (
              <section className="space-y-4">
                <SolidPanel className="flex flex-col items-center p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <SolidPanel className="flex items-center gap-3 p-4">
