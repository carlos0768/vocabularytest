      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6">
          <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-sm text-center">
            ...
            <div className="mb-6">
              <p className="text-5xl font-bold text-red-500 mb-1">
                {percentage}%
              </p>
            ...
            <div className="space-y-3">
              <Button onClick={handleRestart} className="w-full bg-red-500 hover:bg-red-600" size="lg">
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 bg-red-100 px-3 py-1 rounded-full">
          ...
          <span className="text-sm font-medium text-red-700">苦手クイズ</span>
        </div>
      ...
      <main className="flex-1 flex flex-col p-6">
        ...
        {isRevealed && currentQuestion?.word.exampleSentence && (
          <div className="mb-4 p-4 bg-red-50 rounded-xl">
            <p className="text-sm font-medium text-red-800 mb-1">例文</p>
            <p className="text-red-900 italic">{currentQuestion.word.exampleSentence}</p>
            {currentQuestion.word.exampleSentenceJa && (
              <p className="text-sm text-red-700 mt-1">{currentQuestion.word.exampleSentenceJa}</p>
            )}
          </div>
        )}
        ...
        {isRevealed && selectedIndex !== currentQuestion?.correctIndex && (
          <Button onClick={moveToNext} className="w-full bg-red-500 hover:bg-red-600" size="lg">
            次へ
