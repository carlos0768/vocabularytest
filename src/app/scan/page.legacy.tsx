  ...
  return (
    <>
      <SolidPage maxWidth="max-w-2xl">
        ...
        <SolidHeader
          eyebrow="SCAN"
          title={projectId ? '単語を追加' : '写真から単語を抽出'}
          description="ノート、教材、プリントを撮影して、単語帳に入れる英単語を抽出します。"
        />
        <div className="space-y-6">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className="solid-link-secondary"
              >
          ...
          <section className="space-y-3">
            <div className="flex items-center justify-between">
              <SolidSectionTitle icon="tune" title="抽出モード" />
              {!isPro && (
              ...
              {scanModes.map((mode) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`flex h-11 w-11 items-center justify-center rounded-[14px] border-[1.5px] border-[var(--solid-ink)] ${isSelected ? 'bg-[var(--color-surface)]' : 'bg-[var(--color-border-light)]'}`}>
                      <Icon name={mode.icon} size={24} className={isSelected ? 'text-[var(--solid-ink)]' : 'text-[var(--color-muted)]'} />
                    </div>
                    <div>
            ...
            {selectedMode === 'eiken' && (
              <SolidPanel className="animate-fade-in-up p-4">
        ...
        {showProjectNameModal && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <SolidPanel className="w-full max-w-sm animate-fade-in-up p-6">
