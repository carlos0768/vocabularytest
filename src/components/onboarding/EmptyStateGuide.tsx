        ...
        <div className="relative mt-4 flex flex-col gap-2">
          {STEPS.map((s, i) => (
            ...
            >
              ...
              />
              <div className="relative flex items-center gap-3 rounded-[12px] border-2 border-[var(--solid-ink)] bg-[var(--color-surface)] px-3 py-2.5">
                <div
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    <span className="inline-flex h-[16px] w-[16px] items-center justify-center rounded-full border-2 border-[var(--solid-ink)] bg-[var(--solid-ink)] font-mono text-[9px] font-bold leading-none text-[var(--color-on-ink)]">
                      {i + 1}
                    </span>
...
function CtaInner() {
  return (
    <>
      ...
      />
      <span className="relative flex items-center justify-center gap-2 rounded-[14px] border-2 border-[var(--solid-ink)] bg-[var(--solid-ink)] px-5 py-3.5 text-[14px] font-bold text-[var(--color-on-ink)]">
