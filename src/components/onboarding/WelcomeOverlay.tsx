          ...
          >
            ...
            >
              ...
              <button
                ...
                onClick={handleSkip}
                aria-label="スキップ"
                className="absolute right-3 top-3 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full border-2 border-[var(--solid-ink)] bg-[var(--color-surface)] text-[var(--solid-ink)] transition-all duration-100 active:translate-x-px active:translate-y-px"
              >
              ...
              <div className="relative px-6 pb-6 pt-7">
                ...
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="ml-1 inline-flex items-center gap-1 rounded-full border-2 border-[var(--solid-ink)] bg-[var(--color-surface)] px-2 py-[2px] font-mono text-[9px] font-bold tracking-[0.06em] text-[var(--solid-ink)]">
                ...
                <div className="mt-5 flex flex-col gap-2.5">
                  {STEP_CARDS.map((card, i) => (
                    ...
                    >
                      ...
                      />
                      <div className="relative flex items-center gap-3 rounded-[14px] border-2 border-[var(--solid-ink)] bg-[var(--color-surface)] px-3 py-3">
                        <div
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            <span className="inline-flex h-[18px] w-[18px] items-center justify-center rounded-full border-2 border-[var(--solid-ink)] bg-[var(--solid-ink)] font-mono text-[10px] font-bold leading-none text-[var(--color-on-ink)]">
                              {i + 1}
                            </span>
                ...
                >
                  ...
                  />
                  <span className="relative flex items-center justify-center gap-2 rounded-[14px] border-2 border-[var(--solid-ink)] bg-[var(--solid-ink)] px-5 py-[14px] text-[15px] font-bold text-[var(--color-on-ink)]">
