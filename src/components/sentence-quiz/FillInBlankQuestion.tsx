      ...
      <div className="flex-shrink-0">
          ...
          {options.map((option) => {
            ...
            return (
              <button
                ...
                disabled={isRevealed}
                className={`py-2.5 px-5 rounded-2xl font-medium text-base transition-all border-2 ${
                  isRevealed
                    ? isCorrectOption
                      ? 'bg-green-100 text-green-700 border-green-400'
                      : isWrongSelected
        ...
        {!isRevealed ? (
          <Button
            ...
            className="w-full bg-purple-600 hover:bg-purple-700 h-12 text-base rounded-xl"
          >
            回答する
          </Button>
        ) : (
          <div className="flex items-center gap-3">
            ...
            <Button
              onClick={handleNext}
              className="flex-1 bg-purple-600 hover:bg-purple-700 h-12 text-base rounded-xl"
            >
              次へ
            </Button>
          </div>
