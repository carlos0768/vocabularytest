  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end sm:justify-center sm:items-center bg-black/50 p-0 sm:p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-3 sm:pt-4 pb-3 border-b border-[var(--color-border-light)]">
          <span className="w-10" />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="px-5 py-4 border-t border-[var(--color-border-light)] flex gap-3">
            <Button
              type="button"
              variant="secondary"
              onClick={onClose}
