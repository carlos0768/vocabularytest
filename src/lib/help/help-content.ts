    ...
    items: [
      ...
      },
      {
        ...
        body:
          ...
          + '無料プランは1日3回まで、Proプランは回数制限なしで対戦できます。'
          + '回数を数えるのは実際に始まった対戦だけで、相手が見つからずやめたぶんは減りません。',
        href: '/battle',
        linkLabel: '対戦を開く',
        badge: 'free-limited',
      },
    ...
    items: [
      {
        ...
        body:
          ...
          + '1冊に入る単語数に制限はありません。単語対戦は1日3回まで。スキャンは使えません。',
      },
      {
        icon: 'auto_awesome',
        title: 'Proプランでできること',
        body:
          'AIスキャン、単語帳・語法問題集の公開が解放され、単語帳の冊数も無制限になります。'
          + '単語対戦は無料でも1日3回まで遊べますが、Proなら回数制限がなくなります。',
        href: '/subscription',
        linkLabel: 'プランを見る',
      },
      {
