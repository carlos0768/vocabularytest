...
export const SHARE_VIEW_WORD_SELECT_COLUMNS =
  `id, project_id, english, japanese, vocabulary_type, lexicon_entry_id, english_override, japanese_override, distractors, example_sentence, example_sentence_ja, pronunciation, part_of_speech_tags, status, created_at, lexicon_entries(${SHARE_VIEW_LEXICON_SELECT_COLUMNS})` as const;
