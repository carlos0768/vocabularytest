...
3. その単語を使った例文（英語）と日本語訳

【最重要ルール】誤答のフォーマット統一 — 正解が4つの選択肢の中で浮いてはいけない:
...
- 正解「活気、元気、生命力」(3つ) → 誤答も3つずつ「静寂、沈黙、無音」「混乱、騒動、無秩序」「忍耐、根気、辛抱」
...
{
  "results": [
    { "id": "単語のID", "distractors": ["誤答1", "誤答2", "誤答3"], "partOfSpeechTags": ["noun"], "exampleSentence": "Example sentence.", "exampleSentenceJa": "例文の日本語訳。" },
    ...
  ]
}`;
