...
1. 日本語訳の決定（文脈を最優先）:
   ...
   - 画像内に例文・周辺フレーズ・対となる行・近くの注釈などの文脈情報がある場合: その文脈に最も適した意味を選んでください。一般的な辞書意味より、画像に示された文脈に合った意味を優先してください。
...
2. 文脈優先の絶対ルール:
   ...
   - 複数の意味が可能な場合は、画像に見える文章・フレーズ・文脈に最も合う意味を選んでください。
   - 画像に十分な翻訳・文脈情報がない場合のみ、一般的な訳を生成してください。
...
【文脈優先ルール】
- 画像に日本語訳や例文・周辺フレーズなどの文脈情報がある場合は、必ずその文脈に合った意味を使用してください
- 一般的な辞書的意味に置き換えないでください
- 文脈が示す意味を最優先してください

各単語には必ず partOfSpeechTags を付けてください。`;
