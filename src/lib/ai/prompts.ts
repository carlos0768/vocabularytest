...
export const USER_PROMPT_TEMPLATE = `この画像から英単語を抽出してください。難しい単語を優先し、最大30語まで出力してください。基礎的すぎる単語は除外してください。日本語訳が画像に含まれていればそれを使い、なければ適切な日本語訳を生成してください。各単語には必ず partOfSpeechTags を付けてください。`;
...
partOfSpeechTags には noun / verb / adjective / adverb / idiom / phrasal_verb など、最も適切な分類を1つ以上入れてください。`;

export const HIGHLIGHTED_WORD_USER_PROMPT = `この画像で、手書きのマーカーやペンで印をつけた単語だけを抽出してください。印のない単語は含めないでください。`;
